...
namespace AssignmentDay28
{
    ...
    public class UC9 : IAddressBook
    {
        ...
        public void PrintContact(UC9 person)
        {
        ...
        internal void address(string addressbookname, List<UC9> people)
        {
            throw new NotImplementedException();
        }

        internal bool ContainsKey(string addressbookname)
        {
            throw new NotImplementedException();
        }
