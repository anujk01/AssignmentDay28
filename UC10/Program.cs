...
namespace AssignmentDay28
{
    class Program
    {
        public static Dictionary<string, List<UC10>> addressBook = new Dictionary<string, List<UC10>>();
        ...
        static void Main(string[] args)
        {
            ...
            while (noOfBooks < noOfAddressBook)
            {
                ...
                noOfBooks++;
                foreach (KeyValuePair<string, List<UC10>> addr in addressBook)
                {
            ...
            static void SearchAddress(int option)
            {
                ...
                if (option == 1)
                {
                    ...
                    foreach (KeyValuePair<string, List<UC10>> kvp in addressBook)
                    {
                        UC10.StoreCityList(kvp.Key, kvp.Value, city);
                    ...
                    if (option == 2)
                    {
                        ...
                        foreach (KeyValuePair<string, List<UC10>> kvp in addressBook)
                        {
                            UC10.StoreStateList(kvp.Key, kvp.Value, state);
                        }
                    }
                }
            }
